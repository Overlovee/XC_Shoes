...
CREATE TABLE Orders (
	...
	CONSTRAINT FK_Orders_CartID FOREIGN KEY (CartID) REFERENCES Shopping_Cart(CartID),
);
...
END
GO
EXEC dbo.AddNewShoes 'SP',5,N'Nike Spoting 28',6200000,N'Nam','Sport-folder'
...
VALUES('US1',N'Nguyễn Văn Hoàng',N'0124516363',N'Thành phố Hồ Chí Minh',N'140 Lê Trọng Tấn',1),
	  ...
	  ('US003',N'Nguyễn Hoàng Gia',N'032561425',N'Thành phố Hồ Chí Minh',N'21 Cầu Xéo',0);
...
select sh.ShoesID , shd.Name,ts.Name, sh.StyleType, count(cl.ColourID) as 'Number_Colour', Price
from Shoes sh, Shoes_Details shd, Colours cl, Colour_Detail cld, Type_Shoes ts
where sh.ShoesID = shd.ShoesID and cl.ColourID = cld.ColourID and cld.ShoesID = sh.ShoesID
and shd.TypeShoesID = ts.TypeShoesID and sh.StyleType = 'Men'
group by sh.ShoesID, shd.Name, ts.Name, Price, sh.StyleType

select * from Type_Shoes

select shd.Name, sh.StyleType, sh.Price
from Shoes_Details shd, Shoes sh
where shd.ShoesID = sh.ShoesID 
