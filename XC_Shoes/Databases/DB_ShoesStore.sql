...
CREATE TABLE Order_Detail(
	...
	Price DECIMAL(10, 2),
	Ordertime DATETIME,
	CONSTRAINT PK_Orders_Detail PRIMARY KEY (OrderID,ShoesID),
...
--Manage Orders
SELECT OD.ORDERID,OSD.ORDERDATE,OD.TOTAL,OSD.STATUS
FROM ORDERS OD, ORDERSYSTEM OSD
WHERE OD.ORDERID = OSD.ORDERID
